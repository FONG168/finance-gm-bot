...
export function TransactionItem({ transaction, onEdit, onDelete, onClick, index = 0 }: TransactionItemProps) {
  ...
  const body = (
    <>
      ...
      {/* Amount */}
      <p className={cn('font-bold text-sm tabular-nums flex-shrink-0', isIncome ? 'amount-income' : 'amount-expense')}>
